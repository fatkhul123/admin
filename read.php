            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo $row["tunjangan"]; ?></p>
                    </div>
                    <p><a href="index.php" class="btn btn-primary">Kembali</a></p>
                    <p><a href="update.php?id=<?=$id?>" class="btn btn-success">Update</a></p>
                    <p><a href="delete.php?id=<?=$id?>" class="btn btn-danger">Delete</a></p>
